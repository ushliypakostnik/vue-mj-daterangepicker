  ...
  _createClass(default_1, [{
    ...
    value: function hoverizeDay(date) {
      ...
      if (this.weekSelector) {
        ...
        if (this.range) {
          if (!this.values.from && !this.values.to || this.values.from && !this.values.to) {
            availableRange = this.getAllowedDatesOfRange([Object(date_fns["startOfWeek"])(date, {
              weekStartsOn: 1
            }), Object(date_fns["endOfWeek"])(date, {
              weekStartsOn: 1
            })]);
            ...
            if (Object(date_fns["isBefore"])(date, this.values.from)) {
              ...
              if (this.isWeeksRangeOpen) {
                availableRange = this.getAllowedDatesOfRange([Object(date_fns["startOfWeek"])(this.values.from, {
                  weekStartsOn: 1
                }), Object(date_fns["endOfWeek"])(date, {
                  weekStartsOn: 1
                })]);
